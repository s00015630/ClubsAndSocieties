...
namespace ClubsAndSocieties.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Notifications.Include(n => n.associatedAdministrator);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var notification = await _context.Notifications
                .Include(n => n.associatedAdministrator)
        ...
        {
            ViewData["AdminID"] = new SelectList(_context.Administrators, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,AdminID,Title,Date,Message")] Notification notification)
        {
            ...
            ViewData["AdminID"] = new SelectList(_context.Administrators, "Id", "Name", notification.AdminID);
            return View(notification);
        }
